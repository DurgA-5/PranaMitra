      ...
      <div className="flex-1 flex flex-col min-h-0">
        ...
        <div className="flex justify-between items-center mb-5 shrink-0">
          <div className="flex items-center gap-2.5">
            <h2 className="text-base font-bold text-slate-800 tracking-tight">Recent Donors</h2>
                    ...
                    <td className="py-3 px-4 whitespace-nowrap">
                      ...
                      >
                        <span className={`w-1.5 h-1.5 rounded-full ${
                          donor.availableToDonate ? "bg-emerald-500 animate-pulse" : "bg-slate-300"
                        }`} />
                        {donor.availableToDonate ? "Available" : "Busy"}
                      </span>
                    </td>
                    <td className="py-3 px-4 text-center">
                      <button
                        type="button"
                        onClick={() => navigate(`/admin/donors`)}
                        className="text-slate-400 hover:text-red-600 p-1 rounded-lg hover:bg-slate-100 transition inline-flex items-center"
                        title="View donor management"
                      >
                        <Eye size={14} />
                      </button>
                    </td>
