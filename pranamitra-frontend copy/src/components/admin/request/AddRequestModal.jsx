...
function AddRequestModal({ open, onClose, onAdded }) {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      let errorMsg = "Unable to create blood request.";
      if (data) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
      <div className="flex h-full max-h-[80vh] w-full max-w-2xl flex-col rounded-2xl bg-white shadow-2xl animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="flex items-center justify-between border-b border-slate-100 px-6 py-5">
          <div>
            <h2 className="text-xl font-bold text-slate-800">New Blood Request</h2>
